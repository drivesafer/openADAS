...
export const BUILTIN_MANIFESTS: MiniAppManifest[] = [
  {
    id: "traffic-sign",
    name: {
      en: "Traffic Sign Recognition",
      vi: "Nhận diện biển báo",
    },
    description: {
  ...
  },
  {
    ...
    name: {
      en: "Traffic Sign (Tune/Debug)",
      vi: "Biển báo (Chỉnh/Debug)",
    },
    description: {
  ...
  },
  {
    id: "combo",
    name: {
      en: "Signs + Lane Departure",
      vi: "Biển báo + Lệch làn",
    },
    description: {
